...
class PupilTrackingGUI:
    ...
    def _draw_filled_structure(
        ...
        drawing.draw_filled_structure(out, ellipse_data, color, alpha)
    ...
    def _draw_structure(
        ...
        return drawing.draw_structure(out, ellipse_data, color, thickness)

    def _draw_overlay(self, image: np.ndarray, result: Any) -> np.ndarray:
        return drawing.draw_overlay(self, image, result)
