"""Phase XX-F: Correctness + performance comparison against XX-E baseline."""
import json, math, numpy as np

with open('_phase_artifacts/phase_xxe_fair_baseline.json') as f:
    baseline = json.load(f)
with open('_phase_artifacts/phase_xxe_run1.json') as f:
    optimized = json.load(f)

print('=' * 70)
print('CORRECTNESS: XX-E baseline vs XX-F vectorized')
print('=' * 70)
